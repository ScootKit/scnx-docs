...
| Upload attachments to modmail.net | If enabled, message attachments (images, files, etc.) sent in tickets are uploaded to modmail.net for permanent storage. Without this, attachments may become unavailable after Discord's CDN links expire.<br/><small><details><summary>Requirement</summary><blockquote>_Only available if "Enable modmail.net features" is enabled._</blockquote></details></small>                                                             |
