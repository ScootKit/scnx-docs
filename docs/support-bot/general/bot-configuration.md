...
* Choose your preferred activity type such as “Playing”, “Watching”, or “Streaming”.
...
| Field | Description |
| --- | --- |
| Bot status | This text is used for your bot’s status on Discord. |
| Bot status type | This activity type is shown in Discord alongside your status. |
...
* Customize the image used for the default embed footer.
...
| Field | Description |
| --- | --- |
| Default embed footer | This text is used as the default footer in embeds. |
| Default footer image | This image is used for the default footer in embeds. |
