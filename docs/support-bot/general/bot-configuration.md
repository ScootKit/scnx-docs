...
| Command                   | Description                                                                                                                                                                                                                                                                      |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/analytics [days:<1-30>] [member:<User>] [system:<all\|modmail\|ticket-system\|voice-support>]` | Shows support analytics. All options are optional: `days` selects the window (1–30, default 7), `member` narrows to a specific team member, and `system` filters to one product area. Percentages compare the selected window against the preceding window of the same length.<br/><small><details><summary>Requirement</summary><blockquote>_Only available if "Enable analytics command" is enabled._</blockquote></details></small> |
...
| Summary message          | Customize the embed sent when the `/summary` command is run. Modmail and ticket system each have their own template.<br/><small><details><summary>Available placeholders</summary><blockquote>`%summary%` (the AI-generated summary), `%ticketID%`, plus the ticket author's standard user placeholders: `%userID%`, `%tag%`, `%username%`, `%avatarUrl%`, `%mention%`. [Global placeholders](/docs/support-bot/general/global-placeholders) are also available.</blockquote></details><details><summary>Requirement</summary><blockquote>_Only available if "Enable summary command" is enabled._</blockquote></details></small>                                                                                                                                                                                                                                              |
