---
sidebar_position: 1
title: About the Ticket System
description: A powerful channel-based Discord ticket system with claiming, auto-close, forms, feedback, analytics, and more — powered by SCNX.
---
...
* **Analytics**: Track response times, close times, active team members, and more — on the dashboard or with `/analytics`.
* **And much more**: Ticket hold, additional members, statistics channels, AI summaries, estimated wait times, and maintenance mode.
