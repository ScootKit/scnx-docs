...
| `/gmanage reroll msg-id:<GiveawayMessageID> [winner-count:<Number>] [prevent-duplicates:<Boolean>]`                                                                                    | Selects a specified amount of new winners for a giveaway that has already ended. If `prevent-duplicates` is enabled, users who have already won in the original drawing or any previous reroll will be excluded from the new drawing. This works across unlimited rerolls - a user can only win once per giveaway when this option is active.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Blacklist                         | _This field will only work if "Message Count Mode" was set to "blacklist"._<br/>Messages sent in one of these channels won't be counted towards the message count requirement of a giveaway.                                                                                                                                                                                                                                                                                                                                                 |
| Whitelist                         | _This field will only work if "Message Count Mode" was set to "whitelist"._<br/>Only messages sent in these channels will be counted towards the message count requirements of a giveaway.                                                                                                                                                                                                                                                                                                                                                   |
...
| Winner DM Message                         | _This will only work, if you have enabled the "Send DM-Message to winner" configuration option in the [module configuration](#configuration-config) configuration file._ <br/>This message will be sent to the winners via DM.<br/>You can find all available parameters in your dashboard. |
...
- A list of previous winners (used for the prevent-duplicates reroll feature)
...
remove all giveaways, [purge the module database](/docs/custom-bot/additional-features#reset-module-database).
