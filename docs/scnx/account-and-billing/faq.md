...
- **Moderation decisions** (statement of reasons under SCNX ToS §23, sent from `compliance@scnx.xyz` - see the [Policy & Compliance tab](/docs/scnx/guilds/policy#enforcement))
