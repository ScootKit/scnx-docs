...
| Bestenlisten-Titel                                 | Titel der laufenden Bestenlisten-Nachricht. Leer lassen, um den eingebauten Titel zu verwenden.                                                                                                 |
| Bestenlisten-Titel: Endstand                       | Titel der Bestenlisten-Nachricht, sobald sie auf den Endstand umschaltet. Leer lassen, um den eingebauten Titel zu verwenden.                                                                   |
| Bestenlisten-Farbe                                 | Farbe des Bestenlisten-Embeds, zum Beispiel "ORANGE" oder ein Hex-Code wie "#ff7518". Leer lassen für keine Farbe. Ein ungültiger Wert wird ignoriert.                                          |
