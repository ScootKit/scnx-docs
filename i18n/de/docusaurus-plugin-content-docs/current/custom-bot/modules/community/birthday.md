...
- Optionale Vor-Geburtstags-Benachrichtigungen, die eine konfigurierbare Anzahl an Tagen vor dem Geburtstag eines Nutzers gepostet werden. Es können mehrere Vorlaufzeiten konfiguriert werden (z. B. sowohl 7 Tage als auch 1 Tag vor dem Geburtstag), und sie können optional in einen eigenen Kanal geleitet werden, getrennt von den eigentlichen Glückwunsch-Nachrichten.
