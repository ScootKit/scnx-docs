...
| Anhänge aus gelöschten Nachrichten archivieren            | <i>Opt-in. Standardmäßig deaktiviert.</i><br/>Wenn aktiviert, werden Anhänge gelöschter Nachrichten in die <a href="/docs/scnx/guilds/files">Dateibibliothek</a> deines Servers hochgeladen, damit sie auch nach Ablauf der Discord-URLs im Lösch-Log sichtbar bleiben. Aktiviere dies nur, wenn die Aufbewahrung gelöschter Nachrichten-Inhalte mit eurer Server-Policy vereinbar ist. Archivierte Dateien zählen auf dein <a href="/docs/scnx/guilds/files#understanding-storage-limits">Datei-Speicherkontingent</a>, und die globale Kern-Einstellung **Anhang-Archivierung deaktivieren** hat Vorrang. |
