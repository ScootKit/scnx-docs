...
- Kopiere optional die Berechtigungsüberschreibungen der Ticket-Kategorie auf neue Ticket-Kanäle.
...
| Berechtigungen für Kategorien kopieren | Wenn aktiviert, werden beim Öffnen eines Tickets die Berechtigungsüberschreibungen der "Ticketerstellungs-Kategorie" auf den neuen Ticket-Kanal kopiert (`@everyone` bleibt weiterhin ausgeschlossen). Standardmäßig deaktiviert. Spätere Änderungen an der Kategorie werden nicht automatisch übernommen. |
