...
| Teammitglieder-Rollen                                            | Diese Rollen erhalten standardmäßig Zugriff auf Tickets und werden bei der Erstellung eines neuen Tickets erwähnt. Andere Rollen für verschiedene Ticket-Themen kannst du auf der Seite [Ticket-Themen](https://scnx.app/glink?page=support-system/ticket-system/ticket-topics) in deinem Dashboard festlegen, mehr Infos dazu findest du [hier](/de/docs/support-bot/ticket-system/ticket-topics).                          |
...
| Fehler: Ticket nicht gefunden                                         | Diese Nachricht wird dein Bot senden, wenn ein Teammitglied versucht, ein Ticket zu [claimen](/de/docs/support-bot/ticket-system/claiming), welches aber bereits geschlossen oder gelöscht wurde.                                                                                                                                                                    |
