...
| Feld                                                                                                     | Beschreibung                                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ticket-Claiming aktivieren?                                                                              | Aktiviert oder deaktiviert die Funktion für das Ticket-System.                                                                                                                                                                                |
...
| Teammitgliedern erlauben, zugewiesene Teammitglieder zu entfernen oder andere Teammitglieder zuzuweisen? | Wenn aktiviert, können Teammitglieder andere Teammitglieder mit dem Befehl `/ticket assign` dem Ticket zuweisen oder die Zuweisung entfernen.                                                                                                 |
...
| Name, zu welchem das Ticket beim Claim umbenannt werden soll                                             | Dieser Text wird als Name für den Ticket-Kanal verwendet.<br/><small><details><summary>Voraussetzung</summary><blockquote>_Nur verfügbar, wenn "Tickets umbenennen, wenn sie geclaimt werden?" aktiviert ist._</blockquote></details></small> |
