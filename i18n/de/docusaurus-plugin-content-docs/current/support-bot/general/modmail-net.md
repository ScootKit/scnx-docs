...
| Ticket-Logs auf modmail.net hochladen | Wenn aktiviert, werden Ticket-Transkripte nach dem Schließen eines Tickets automatisch auf modmail.net hochgeladen. Nutzer und Teammitglieder können die Logs dann in einem formatierten Web-Layout ansehen, indem sie auf den Knopf in der Log-Kanal-Nachricht klicken, anstatt eine Textdatei herunterzuladen.<br/><small><details><summary>Voraussetzung</summary><blockquote>_Nur verfügbar, wenn „modmail.net Funktionen aktivieren" aktiviert ist._</blockquote></details></small> |
