...
| Lokales Bundesland                                                       | *Nur verfügbar, wenn "An Feiertagen komplett schließen?" aktiviert ist.*<br/>Dieses Bundesland wird für die Erkennung von Feiertagen verwendet (falls unterstützt). Die Daten werden von [OpenHolidays](https://www.openholidaysapi.org/en/) bereitgestellt. |
